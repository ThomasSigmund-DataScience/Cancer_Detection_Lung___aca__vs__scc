...
model_path = 'model___STRATEGY_2___40_epochs___4_convLayers___2024-11-29_112023.sav'
...
st.subheader('Cancer aca  vs.  cancer scc')
...
if image_file is not None:
    ...
    if predicted_class == 0:  # 0 is for lung cancer aca
        st.write("Cancerous - ACA")
    else:                     # 1 is for lung cancer scc
        st.write("Cancerous - SCC")
